...
impl TaskManager {
    ...
    fn run_first_task(&self) -> ! {
        ...
        next_task.begin_time = get_time_us();
    ...
    fn current_task_info(&self) -> TaskInfo {
        ...
        TaskInfo {
            ...
            time: (get_time_us() - task.begin_time) / 1000,
        }
    }
...
pub fn translated_current_ptr<T>(ptr: *mut T) -> *mut T {
    translated_ptr(current_user_token(), ptr)
}
